...
public class BSRenderManager extends RenderManager {
    ...
    public void irenderModelPartsStaticLight(List<IBakedModelPart> parts, WorldRef ref, Vect3d offset) {
        ...
        IBlockAccess world = MinecraftForgeClient.getRegionRenderCache(ref.getWorld(), ref.getPosition().toBlockPos());
        ...
        Minecraft.getMinecraft().getBlockRendererDispatcher().getBlockModelRenderer()
                .renderModel(world, cache, ref.getBlockState(), ref.getPosition().toBlockPos(), worldRenderer, false);
