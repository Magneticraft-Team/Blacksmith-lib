...
public class ModelPartBlockSide implements IModelPart {
    ...
    protected Set<Direction> sides = new HashSet<>();
    protected List<IQuad> quads = new LinkedList<>();

    public ModelPartBlockSide(Direction dir, ITexture texture) {
        this.texture = texture;
        this.sides.add(dir);
        generateQuads();
    }

    public ModelPartBlockSide(List<Direction> dir, ITexture texture) {
        this.texture = texture;
