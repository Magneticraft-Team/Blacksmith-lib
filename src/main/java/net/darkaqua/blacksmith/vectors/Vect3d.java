 ...
 */
public class Vect3d implements Comparable<Vect3d> {
    ...
    public Vect3d(NBTTagCompound pos) {
        this(pos.getDouble("x"), pos.getDouble("y"), pos.getDouble("z"));
    }

    public Vect3d(BlockPos pos) {
        this(pos.getX(), pos.getY(), pos.getZ());
    }

    public Vect3d(Vec3 vec3) {
    ...
    public Vect3d add(EnumFacing dir) {
    ...
    public Vect3d unitVector() {
        if (isNullVector()) { return nullVector(); }
    ...
    public Vect3d rotateCustom(Vect3d axis, double angle) {
        if (axis.isNullVector()) { return this; }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Vect3d)) {
            return false;
        }

        Vect3d vect3d = (Vect3d) o;

        return Double.compare(vect3d.x, x) == 0 && Double.compare(vect3d.y, y) == 0 && Double.compare(vect3d.z, z) == 0;
    }
    ...
    @Override
    public int compareTo(@Nonnull Vect3d vec) {
